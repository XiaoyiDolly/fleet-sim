...
# state_features = 34
#    time_feature: 4
#    fingerprint_feature: 2
#    m.mean(): NUM_SUPPLY_DEMAND_MAPS * 1 = 5
#    m[x,y] in M: NUM_SUPPLY_DEMAND_MAPS * (FLAGS.n_diffusions + 1) = 5 * 4 = 20
#    m[x,y] in d_entropy: 1 + 1 * (FLAGS.n_diffusions - 1) = FLAGS.n_diffusions = 3
# action_features = 24
#    trip_time: 1
#    m[x_,y_] in M: NUM_SUPPLY_DEMAND_MAPS * (FLAGS.n_diffusions + 1) = 5 * 4 = 20
#    m[x_,y_] in d_entropy: 1 + 1 * (FLAGS.n_diffusions - 1) = FLAGS.n_diffusions = 3
